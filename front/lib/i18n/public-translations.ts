...
const FALLBACK_TRANSLATIONS: Record<string, Record<string, string>> = {
  fr: {
    ...
    "home.search.all_categories": "Toutes les catégories",
    "home.search.category_label": "Catégorie",
    "home.search.eyebrow": "Marketplace public",
    "home.search.query_label": "Rechercher",
    "home.search.query_placeholder": "Événement, formation, stand...",
    "home.search.submit": "Explorer",
    "home.search.title": "Trouvez rapidement un contenu",
  ...
  en: {
    ...
    "home.search.category_label": "Category",
    "home.search.eyebrow": "Public marketplace",
    "home.search.query_label": "Search",
    "home.search.query_placeholder": "Event, training, stand...",
    "home.search.submit": "Explore",
    "home.search.title": "Quickly find content",
