...
use App\Tenancy\Bootstrappers\SlugFilesystemTenancyBootstrapper;
...
return [
    ...
    'bootstrappers' => [
        ...
        SlugFilesystemTenancyBootstrapper::class,
     ...
     */
    'database' => [
        'central_connection' => env('CENTRAL_DB_CONNECTION', env('DB_CONNECTION', 'central')),
