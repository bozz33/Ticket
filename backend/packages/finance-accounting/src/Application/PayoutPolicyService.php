...
namespace Ticket\FinanceAccounting\Application;
...
class PayoutPolicyService implements PayoutPolicyCatalog
{
    public function resolvePolicy(Tenant $tenant, ?string $currencyCode = null): ?PayoutPolicy
    {
        ...
        return PayoutPolicy::query()
            ...
            ->get()
            ->filter(function (PayoutPolicy $policy): bool {
    ...
    public function availableBalance(Tenant $tenant, ?string $currencyCode = null): array
    {
        ...
        $successfulStatuses = PaymentStatuses::successful();
